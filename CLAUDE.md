...
"Do and Done" is a productivity application designed to track both planned tasks and actual activities. The project is currently in the planning phase with technical requirements documented.

## Planned Technology Stack

### Frontend
- **Web**: React + TypeScript + Vite, Tailwind CSS, Redux Toolkit/Zustand, Framer Motion
...
Since no implementation exists yet, here are the expected commands once the project is set up:
...
- **Phase 1 (MVP)**: Basic todo functionality, activity logging, mobile app, authentication
...
- The project emphasizes tracking "planned vs actual" activities as its unique feature
